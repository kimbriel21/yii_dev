 ...
 *
 * In addition to the {@link message} property for setting a post error message,
 * CNumberValidator has a couple post error messages you can set that correspond to different
 * validation scenarios. To specify a post message when the numeric value is too big,
