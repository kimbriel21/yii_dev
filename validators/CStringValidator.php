 ...
 * CStringValidator has a couple post error messages you can set that correspond to different
 * validation scenarios. For defining a post message when the string is too short,
