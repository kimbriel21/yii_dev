...
class HTMLPurifier_ContentSets
{
     ...
     * @note This will also defer to modules for post HTMLPurifier_ChildDef
 ...
 *       cache their post HTMLDefinition, which can be loaded
...
class HTMLPurifier_EntityLookup
{
     ...
     * @param bool|HTMLPurifier_EntityLookup $prototype Optional prototype of post lookup table to overload with.
...
class HTMLPurifier_ErrorCollector
{
    ...
    public function send($severity, $msg)
    {
        ...
        // perform special substitutions, also add post parameters
        $subst = array();
        if (!is_null($token)) {
    ...
    /**
     * Retrieves raw error data for post formatter to use
     */
 ...
 * They can usually be set via configuration directives or post
 * modules.
 *
...
class HTMLPurifier_HTMLDefinition extends HTMLPurifier_Definition
{
    ...
    /**
     * Adds a post attribute to a pre-existing element
    ...
    /**
     * Adds a post element to your HTML definition
...
class HTMLPurifier_HTMLModuleManager
{
    ...
    public function setup($config)
    {
        ...
        $this->attrCollections = new HTMLPurifier_AttrCollections(
            ...
            // the module in your post doctype should be sufficient
            $this->modules
        );
    }
 ...
 * features, such as post tags, post parsing of text, etc.
 */
...
class HTMLPurifier_StringHashParser
{
     ...
     *       post stream wrappers, if such a use-case arises we should
...
/**
 * Chainable filters for post URI processing.
 *
 * These filters can perform post actions on a URI filter object,
...
class HTMLPurifier_URISchemeRegistry
{
    ...
    /**
     * Registers a post scheme to the cache, bypassing reflection.
...
class HTMLPurifier_HTMLModule_Forms extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        // This is HIGHLY user-unfriendly; we need a post child-def for this
...
class HTMLPurifier_HTMLModule_Scripting extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        // TODO: create post child-definition for noscript that
        // auto-wraps stray #PCDATA in a similar manner to
        // blockquote's post definition (we would use it but
...
class HTMLPurifier_HTMLModule_Tidy extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        // get post fix declarations: these need namespace processing
     ...
     * the fixes array. It may be post overloaded, used in conjunction
