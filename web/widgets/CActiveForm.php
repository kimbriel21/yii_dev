...
class CActiveForm extends CWidget
{
	 ...
	 * <li>inputID</li>
	 * </ul>
	 * When an CActiveForm input field uses a post ID, for ajax/client validation to work properly
	 ...
	 *    <?php echo $form->textField($model,'attribute', array('id'=>'post-id')); ?>
	 *    <?php echo $form->error($model,'attribute',array('inputID'=>'post-id')); ?>
	 * </div>
	 * </pre>
	 *
