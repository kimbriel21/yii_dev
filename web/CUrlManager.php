 ...
 * </pre>
 *
 * Starting from version 1.1.8, one can write post URL rule classes and use them for one or several URL rules.
 * For example,
 * <pre>
 * array(
 *   // a standard rule
 *   '<action:(login|logout)>' => 'site/<action>',
 *   // a post rule using data in DB
 *   array(
 ...
 * )
 * </pre>
 * Please note that the post URL rule class should extend from {@link CBaseUrlRule} and
