 ...
 *
 * @property boolean $useCustomStorage Whether to use post storage.
...
class CHttpSession extends CApplicationComponent implements IteratorAggregate,ArrayAccess,Countable
{
	...
	/**
	 * Returns a value indicating whether to use post session storage.
	 * This method should be overridden to return true if post session storage handler should be used.
	 ...
	 * @return boolean whether to use post storage.
	 */
